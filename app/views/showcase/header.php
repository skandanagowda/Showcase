...
<head>
    ...
    <link rel="stylesheet" href="<?=ASSETS?>showcase/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=ASSETS?>showcase/fontawesome/css/all.min.css">
    <link rel="stylesheet" href="<?=ASSETS?>showcase/css/templatemo-style.css">
    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <!--<li class="nav-item">
                    <a class="nav-link nav-link-2 videos">Videos</a>
                </li>-->
                <li class="nav-item">
